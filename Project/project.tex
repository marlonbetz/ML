...
For the word2vec models, I used the implementations provided by the Gensim\footnote{http://radimrehurek.com/gensim} library for Python. For the implementation of the PLM, I used Keras\footnote{http://keras.io}. For the detailed overview on the different word2vec models, I made use of the blog posts of my former IBM co-internee Sebastian Ruder\footnote{http://sebastianruder.com}.
